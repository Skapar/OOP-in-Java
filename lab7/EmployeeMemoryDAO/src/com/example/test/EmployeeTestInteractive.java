...
public class EmployeeTestInteractive {
    ...
    public static Employee inputEmployee(BufferedReader in, Employee empDefaults, boolean newEmployee) throws IOException {
        ...
        prompt = "Enter value for employee birth date (e.g., Jan 31, 2000)" + ((empDefaults == null) ? "" : " [" + df.format(empDefaults.getBirthDate()) + "]");
        ...
        while (birthDate == null) {
            ...
            if (dateStr.equals("") && empDefaults != null) {
                ...
                try {
                    ...
                    System.out.println("Invalid format. Please retry with a valid birth date in the format 'MMM d, yyyy'. For example, 'Nov 2, 2004'.");
                }
            }
        }
